...
// Add creates a new DatabaseRestore Controller and adds it to the Manager with default RBAC. The Manager will set fields on the Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to DatabaseRestore
	...
	// Uncomment watch a Deployment created by DatabaseRestore - change this for objects you create
...
// ReconcileDatabaseRestore reconciles a DatabaseRestore object
type ReconcileDatabaseRestore struct {
	client.Client
	scheme *runtime.Scheme
}

// Reconcile reads that state of the cluster for a DatabaseRestore object and makes changes based on the state read
// and what is in the DatabaseRestore.Spec
...
func (r *ReconcileDatabaseRestore) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the DatabaseRestore instance
